 ...
 * http://jsbin.com
 * Copyright (c) 2020 by RHieger (http://jsbin.com/modizew/3/edit)
 ...
 *
 * Chapter 9: Listing 9.12--A Player Constructor Function
 *
*/
...
console.log('\n\nLISTING FOR spacer.blank() method:');
console.log('---------------------------------\n');
console.log(spacer.blank.toString(), '\n');

console.log('LISTING FOR spacer.newLine() method:');
console.log('-----------------------------------\n');
console.log(spacer.newLine.toString(), '\n');

console.log('LISTING FOR spacer.line() method:');
console.log('--------------------------------\n');
console.log(spacer.line.toString(), '\n');

console.log('LISTING FOR spacer.wrap() method:');
console.log('--------------------------------\n');
...
console.log('LISTING FOR spacer.box() method:');
console.log('-------------------------------\n');
...
console.log('\nSAMPLE CALL TO player1.showInfo():');
console.log('---------------------------------\n');
